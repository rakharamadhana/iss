        ...
        <ul class="navbar-nav">
            ...
            @else
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-secondary" aria-labelledby="navbarDropdownMenuUser">
                        @can('view backend')
                            <a href="{{ route('admin.dashboard') }}" class="dropdown-item">@lang('navs.frontend.user.administration')</a>
                        @endcan

                        <a href="{{ route('frontend.user.dashboard')}}" class="dropdown-item {{ active_class(Route::is('frontend.user.dashboard')) }}">@lang('navs.frontend.dashboard')</a>
